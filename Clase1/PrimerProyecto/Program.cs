...
//         {
//             Logger.Log("¿Cómo te llamas?");
//             string nombre = Console.ReadLine() ?? "Invitado"; //El ?? ...  es un valor por defecto
...
namespace SegundaClase
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var diccionario in dic)
            {
                // Console.WriteLine($"Clave {i}: {valor}");
                // Console.WriteLine(valor);
                // i++;
                Console.WriteLine($"Clave: {diccionario.Key}, Valor: {diccionario.Value}");
            }
